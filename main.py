...
#
#  main.py implements the Route Planning System control class.
#
#  The key public methods are:
#  1. luckyRoute(), under route_plot(), which handles the planning of a route under the "I'm Feeling Lucky" option
#
#  @author chayhuixiang
#
...
def route_plot():
  try:
    ...
    if target_dist <= 0:
      raise Exception("Invalid target distance")

    for n in nodes_dict.keys():
      nodes_dict[n].is_visited = False
